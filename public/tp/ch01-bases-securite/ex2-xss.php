...
<div class="page-header">
    <h2>Ch1 — Ex2 : Exploitation XSS</h2>
    ...
    <div id="vuln" class="tab-content active">
        ...
        <div class="explanation" style="margin-top:20px;">
            ...
            <ul style="margin:10px 0 0 20px;">
                <li><code>&lt;script&gt;alert('XSS')&lt;/script&gt;</code> — Script classique</li>
                <li><code>&lt;img src=x onerror="alert(document.cookie)"&gt;</code> — Vol de cookies</li>
                <li><code>&lt;svg onload="alert('XSS')"&gt;</code> — Via SVG</li>
                <li><code>&lt;a href="javascript:alert('XSS')"&gt;Cliquez&lt;/a&gt;</code> — Via lien</li>
            </ul>
        </div>
    </div>
...
<span class="vulnerable">echo $_GET['q'];
echo $comment['content'];</span>
        </div>
    </div>
    <div class="card">
        <h3>Code Sécurisé</h3>
